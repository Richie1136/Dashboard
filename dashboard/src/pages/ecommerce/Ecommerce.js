    ...
    <div className="mt-12">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              ...
              <div className="mt-5">
                <SparkLine color={currentColor} data={SparklineAreaData} currentColor={currentColor} id="line-sparkline" type="Line" height="80px" width="250px" />
              </div>
              <div className="mt-10">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="md:w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">Weekly Sales</p>
          ...
          <div className="mt-10">
            {weeklyStats?.map((item) => (
              <div key={item.ittle} className="flex justify-between mt-4 w-full">
                <div className="flex gap-4">
                  <button type='button' style={{ background: item.iconBg }} className='text-2xl hover:drop-shadow-xl text-white rounded-full p-3'>{item.icon}</button>
                  <div>
                    <p className="text-md font-semibold">{item.title}</p>
                    <p className="text-sm text-gray-400">{item.desc}</p>
                  </div>
